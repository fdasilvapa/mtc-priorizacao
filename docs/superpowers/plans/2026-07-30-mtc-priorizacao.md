...
Abrir o SQL Editor do projeto no painel do Supabase e executar os três arquivos **em ordem**. Os scripts são idempotentes — rodar de novo é seguro.

O SQL Editor executa tudo numa transação: se qualquer statement falhar, o bloco inteiro reverte e nada foi aplicado.
